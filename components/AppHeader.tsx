      ...
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
        <div className="flex items-center gap-1 sm:gap-6">
          ...
          <nav className="flex gap-1">
            <Link href="/generate" className="flex items-center gap-1.5 rounded-lg px-2 py-1.5 text-sm font-medium text-zinc-400 transition-colors hover:text-zinc-100 focus:text-zinc-100 sm:px-3">
              <Sparkles className="h-4 w-4 shrink-0 sm:hidden" />
              <span className="hidden sm:inline">{t("generate")}</span>
            </Link>
            <Link href="/recipes" className="flex items-center gap-1.5 rounded-lg px-2 py-1.5 text-sm font-medium text-zinc-400 transition-colors hover:text-zinc-100 focus:text-zinc-100 sm:px-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <form action={logoutAction}>
            <button
              type="submit"
              className="cursor-pointer whitespace-nowrap rounded-xl border border-white/10 bg-white/5 px-3 py-1.5 text-sm font-medium text-zinc-400 transition-all duration-200 hover:border-white/18 hover:bg-white/8 hover:text-zinc-100 focus:border-white/18 focus:bg-white/8 focus:text-zinc-100 sm:px-4"
            >
              {t("signOut")}
            </button>
          </form>
