    ...
    <div className="space-y-5">
            ...
            {ingredients.map((ingredient, index) => (
              ...
              >
                ...
                <button
                  ...
                  className="mt-px text-orange-400 transition-colors hover:text-orange-600 focus:text-orange-600 cursor-pointer"
                >
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="flex h-[42px] w-[42px] items-center justify-center rounded-xl border border-zinc-200 bg-white text-zinc-500 transition-colors hover:border-orange-400 hover:text-orange-500 focus:border-orange-400 focus:text-orange-500 disabled:opacity-40 cursor-pointer disabled:cursor-not-allowed"
        >
      ...
      <button
        ...
        className="w-full rounded-xl bg-orange-500 py-3 text-sm font-semibold text-white shadow-md shadow-orange-500/20 transition-all hover:bg-orange-400 focus:bg-orange-400 disabled:pointer-events-none disabled:opacity-50 cursor-pointer"
      >
