        ...
        <AnimatedSection className="space-y-6">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 rounded-xl bg-orange-500 py-2.5 text-sm font-semibold text-white shadow-md shadow-orange-500/20 transition-colors hover:bg-orange-400 focus:bg-orange-400 cursor-pointer"
            >
              {t("result.viewFullRecipe")}
            </button>
            <button
              onClick={handleStartOver}
              className="flex-1 rounded-xl border border-zinc-200 bg-white py-2.5 text-sm font-medium text-zinc-600 transition-colors hover:border-zinc-300 hover:text-zinc-800 focus:border-zinc-300 focus:text-zinc-800 cursor-pointer"
            >
              {t("result.startOver")}
            </button>
          </div>
